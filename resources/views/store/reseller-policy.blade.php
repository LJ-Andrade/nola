...
<div class="container info-container">
        ...
        <div class="row text-center">
            <div class="col-sm-12 col-md-6 col-lg-4 item">
                <img src="{{ asset('images/web/icons/icon-cart.png') }} " alt="Compras">
                <p>Compra inicial de <br><b>$30000</b></p>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4 item">
                <img src="{{ asset('images/web/icons/icon-truck.png') }} " alt="Compras">
                <p>Reposiciones mensuales por <br> <b>$40000</b></p>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4 item">
                <img src="{{ asset('images/web/icons/icon-shield.png') }} " alt="Compras">
