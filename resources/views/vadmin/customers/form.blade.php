    ...
    <div class="row">
        <div class="col-lg-4 col-md-6">
            ...
            <div class="form-group">
                ...
                {!! Form::select('group', ['2' => 'Minorísta', '3' => 'Mayorísta'], 
                null ,
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="form-group">
                ...
                {!! Form::text('phone', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el WhatsApp']) !!}
            </div>
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="form-group">
                ...
                @if(isset($customer))
                    ...
                    @else
                        <select id='GeoLocsSelect' name="geoloc_id" data-actualloc="" data-actuallocid="" class="form-control GeoLocsSelect"></select>
                    @endif
                @else
                    <select id='GeoLocsSelect' name="geoloc_id" data-actualloc="" data-actuallocid="" class="form-control GeoLocsSelect"></select>
                @endif
