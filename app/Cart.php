...
class Cart extends Model
{
    ...
    protected $fillable = ['customer_id', 'status', 'shipping_id', 'shipping_price', 'bus_name', 'payment_method_id', 'payment_percent',
     'payment_token', 'mp_preference_id', 'mp_collection_id', 'mp_payment_type', 'mp_merchant_order_id', 'payment_status',
     'notes', 'order_date', 'arrived_date'];
